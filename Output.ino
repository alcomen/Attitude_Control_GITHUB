...
void output_angles()
{
  ...
  else if (output_format == OUTPUT__FORMAT_TEXT)
  {
    ...
    Serial.print(TO_DEG(roll)); Serial.print('\f');
    #endif
    
    #if PRINT_SENSOR_DATA_RAW == 1
    Serial.print("#GYRO#XYZ=");
    Serial.print(sen_data.gyro_y_raw); Serial.print(",");
    Serial.print(sen_data.gyro_y_raw); Serial.print(",");
    Serial.print(sen_data.gyro_z_raw); Serial.println();
    #endif
    
    #if PRINT_SENSOR_DATA == 1
    Serial.print("#GYRO#XYZ=");
    Serial.print(sen_data.gyro_x); Serial.print(",");
    Serial.print(sen_data.gyro_y); Serial.print(",");
    Serial.print(sen_data.gyro_z); Serial.println();
    #endif
    
    #if PRINT_MOTORS == 1
    Serial.print("MSG_ID:");
    Serial.println(sen_data_local.msg_id, DEC);
      
    Serial.print ("MOTORS RECEIVED XYZ:   ");
    Serial.print(mot_data_received.motor_x_sp);
    Serial.print (",");
    Serial.print(mot_data_received.motor_y_sp);
    Serial.print (",");
    Serial.print(mot_data_received.motor_z_sp);
      
    //Serial.println();
      
    Serial.print ("MOTORS FEEDBACK XYZ:   ");
    Serial.print(sen_data_local.motor_x_sp);
    Serial.print (",");
    Serial.print(sen_data_local.motor_y_sp);
    Serial.print (",");
    Serial.print(sen_data_local.motor_z_sp);
      
    //Serial.println();
      
    Serial.print ("MOTORS REAL SPEED XYZ: ");
    Serial.print(sen_data_local.motor_x_sp+motor_speed_default);
    Serial.print (",");
    Serial.print(sen_data_local.motor_y_sp+motor_speed_default);
    Serial.print (",");
    Serial.print(sen_data_local.motor_z_sp+motor_speed_default);
